        ...
        <div className="shadow p-5 bg-light" style={{ maxWidth: '800px', marginBottom: '15px', borderRadius: '5px' }}>
            <div className="card-body d-flex justify-content-center align-items-center">
                <div>
                    ...
                    <p className='mb-0'>
                        Thank you for completing the Assessment! We will contact you regarding your application if we are interested in speaking with you. Performance on this assessment is only a component of our application review process.
                    </p>
                </div>
            </div>
        </div>
